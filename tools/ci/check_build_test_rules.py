...
def generate_new_support_table(targets: t.List[str]) -> str:
    # extra space here
...
def parse_existing_table(app_dir: str) -> t.Tuple[t.Optional[str], t.List[str]]:
...
def get_grouped_cases(paths: t.List[str]) -> t.Dict[str, t.Dict[str, t.Set[str]]]:
    """
...
def check_test_scripts(
    ...
    exclude_dirs: t.Optional[t.List[str]] = None,
    *,
    bypass_targets: t.Optional[t.List[str]] = None,
) -> None:
